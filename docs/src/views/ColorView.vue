<template>
  ...
  <div class="grid">
    <div class="columna-2 m-y-1 gobmx-fondo-oscuro-1 borde-redondeado-8"></div>
    <div class="columna-2">
      <p>.gobmx-fondo-oscuro-1</p>
      <p>#18302D</p>
    </div>
    <div class="columna-2 m-y-1 gobmx-fondo-oscuro-2 borde-redondeado-8"></div>
    <div class="columna-2">
  ...
  <div class="grid">
    <div class="columna-2 m-y-1 gobmx-borde-oscuro-1 borde borde-grosor-3 borde-redondeado-8"></div>
    <div class="columna-2">
      <p>.gobmx-borde-oscuro-1</p>
    </div>
    <div class="columna-2 m-y-1 gobmx-borde-oscuro-2 borde borde-grosor-3 borde-redondeado-8"></div>
    <div class="columna-2">
      <p>.gobmx-borde-oscuro-2</p>
    </div>
    <div class="columna-2 m-y-1 gobmx-borde-claro-1 borde borde-grosor-3 borde-redondeado-8"></div>
    <div class="columna-2">
      <p>.gobmx-borde-claro-1</p>
    </div>
    <div class="columna-2 m-y-1 gobmx-borde-claro-2 borde borde-grosor-3 borde-redondeado-8"></div>
    <div class="columna-2">
      <p>.gobmx-borde-claro-2</p>
    </div>
    <div class="columna-2 m-y-1 gobmx-borde-acento borde borde-grosor-3 borde-redondeado-8"></div>
    <div class="columna-2">
  ...
  <div class="grid">
    <div class="columna-2 m-y-1 borde-informativo  borde borde-grosor-3 borde-redondeado-8"></div>
    <div class="columna-2">
      <p>.borde-informativo</p>
    </div>
    <div class="columna-2 m-y-1 borde-error  borde borde-grosor-3 borde-redondeado-8"></div>
    <div class="columna-2">
      <p>.borde-error</p>
    </div>
    <div class="columna-2 m-y-1 borde-advertencia  borde borde-grosor-3 borde-redondeado-8"></div>
    <div class="columna-2">
      <p>.borde-advertencia</p>
    </div>
    <div class="columna-2 m-y-1 borde-correcto  borde borde-grosor-3 borde-redondeado-8"></div>
    <div class="columna-2">
      <p>.borde-correcto</p>
    </div>
  </div>
